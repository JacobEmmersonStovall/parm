# function-generate-static-node-view Pub/Sub Google Cloud Function
...
## Test the function
    nx test function-generate-static-node-view

## Deploy the function
    nx build function-generate-static-node-view
    nx deploy function-generate-static-node-view
...
### Nx Commands
    nx lint function-generate-static-node-view
    nx format:write function-generate-static-node-view
    nx format:write  function-generate-static-node-view
    nx format:check  function-generate-static-node-view
    nx affected --target=build
    nx build function-generate-static-node-view --with-deps

### Google Cloud Commands
    gcloud functions deploy functionGenerateStaticNodeView --set-env-vars foo=bar, zoo=lop
    gcloud functions functionGenerateStaticNodeView --update-env-vars foo=bar, zoo=lop
    gcloud functions deploy functionGenerateStaticNodeView --service-account emailOfServiceAccount
    gcloud functions deploy functionGenerateStaticNodeView --max-instances maxInstancesCount
    gcloud functions deploy functionGenerateStaticNodeView --clear-max-instances
    gcloud functions logs read functionGenerateStaticNodeView
